...
const VoteWindow = (props) => {
  ...
  const submitHandler = async () => {
    let walletKey = await props.Web3States.accounts[0];
    let voterid = await props.Web3States.contractInst.methods.getVoterId(walletKey).call();
    ...
    try{
      console.log(await props.Web3States.contractInst.methods.vote(voterid, walletKey, choice)
